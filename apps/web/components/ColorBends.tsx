...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    const rendererAny = renderer as THREE.WebGLRenderer & { outputColorSpace?: number };
    if (typeof rendererAny.outputColorSpace !== 'undefined') {
      rendererAny.outputColorSpace = (THREE as typeof THREE & { SRGBColorSpace?: number }).SRGBColorSpace ?? 1;
    }
  ...
  return <div ref={containerRef} className={`w-full h-full relative overflow-hidden ${className}`} style={style} aria-hidden />;
}
