...
export default function SignupAnalystPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            const res = await fetch(`${API_URL}/auth/register/analyst`, {
                method: 'POST',
            ...
            <div className="w-full max-w-md space-y-6 relative z-10">
                <Card className="border-white/10 bg-white/5 backdrop-blur-xl text-white shadow-2xl">
                    <CardHeader className="space-y-1 text-center">
                        <CardTitle className="text-2xl font-bold tracking-tight">Sign up as Analyst</CardTitle>
                        <CardDescription>Register to access analytics. Your account will be reviewed by an admin.</CardDescription>
                    </CardHeader>
                    <CardContent>
